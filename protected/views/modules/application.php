...
<div class="bloc">
    ...
    <div class="content">		
		...
		<tr>
			...
			<th class="center" style="width:100px;"><?php echo A::t('app', 'Installed'); ?></th>
			<th class="center" style="width:100px;"><?php echo A::t('app', 'Updated'); ?></th>
			<th class="center" style="width:75px;"><?php echo A::t('app', 'Version'); ?></th>
			<th class="center" style="width:80px;"><?php echo A::t('app', 'Status'); ?></th>
			<th class="center" style="width:65px;"><?php echo A::t('app', 'Order'); ?></th>
