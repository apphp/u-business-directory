<?php
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('app', 'Social Login'), 'url'=>'social/socialLogin'),
...
<div class="bloc">
    ...
    <?php
        ...
        echo CWidget::create('CDataForm', array(
            ...
            'primaryKey'        => $id,
            'operationType'     => 'edit',
            'action'            => 'social/socialEdit/id/'.$id,
            ...
            'fields'                => array(
                'icon' => array(
                    ...
                    'deleteOptions'     => array('showLink'=>true, 'linkUrl'=>'social/socialEdit/id/'.$id.'/delete/image', 'linkText'=>A::t('app', 'Delete')),
                ...
                'is_published' => array('type'=>'checkbox', 'title'=>A::t('app', 'Published'), 'default'=>1, 'validation'=>array('type'=>'set', 'source'=>array(0, 1)), 'data'=>array(0 => A::t('app', 'No'), 1 => A::t('app', 'Yes'))),
