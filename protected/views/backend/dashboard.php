...
<div class="bloc" id="blocHotKeys">
    ...
    <div class="content sortable-content">		
		...
		<?php if(Admins::hasPrivilege('payment_providers', 'view')){ ?><a href="paymentProviders/" id="icon-payment-providers" class="shortcut tooltip-link" title="<?php echo A::t('app', 'Payment Providers'); ?>"><?php echo CString::substr(A::t('app', 'Payment Providers'), 12, false, true); ?><img src="templates/backend/images/shortcuts/payment-providers.png" alt="payment providers" /></a><?php } ?>
