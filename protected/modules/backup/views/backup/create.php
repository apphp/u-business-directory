...
<h1><?php echo A::t('backup', 'Create Backup')?></h1>	
...
<div class="bloc">
    ...
    <?php echo $actionMessage; ?>
		...
		<fieldset>
		    <legend><?php echo A::t('backup', 'Backup your current installation'); ?></legend>
			<?php		
		...
		<fieldset>
		    <legend><?php echo A::t('backup', 'Existing Backups:'); ?></legend>
			<table>
			<tbody>
			<?php 
