...
(NULL, 'backup', 'Backup', 'Backup', 'Backup and Restore module allows backup and restore site database', '0.0.5', 'icon.png', 0, 0, 1, 0, 1, '<CURRENT_DATETIME>', '0000-00-00 00:00:00', (SELECT COUNT(m.id) FROM `<DB_PREFIX>modules` m));
