<?php
    ...
    $this->_breadCrumbs = array(
        ...
        array('label'=>A::t('banners', 'Edit Banner')),
    );
?>
...
<div class="bloc">
    ...
    <div class="sub-title"><?php echo A::t('banners', 'Edit Banner'); ?></div>
    <div class="content">
    <?php
        echo CWidget::create('CDataForm', array(
            ...
            'fields'=>array(
                'image_file' => array(
                    ...
                    'imageOptions'  => array('showImage'=>true, 'showImageName'=>true, 'showImageSize'=>true, 'imageClass'=>'icon-big'),
                    ...
                    'fileOptions'   => array('showAlways'=>false, 'class'=>'file', 'size'=>'25', 'filePath'=>'images/modules/banners/')
                ),
