		...
		if($keywords !== ''){
			...
			foreach($news as $key => $val){
				$result[0][] = array(
					...
					'intro_image'	=> (!empty($val['intro_image']) ? '<img class="intro-thumb news-intro-thumb" src="images/modules/news/intro_images/'.CHtml::encode($val['intro_image']).'" alt="news intro" />' : ''),
