...
(NULL, 'webforms', 'WebForms', 'Web Forms', 'Web Forms module allows creating online forms on site pages', '0.0.3', 'icon.png', 0, 0, 1, 0, 1, '<CURRENT_DATETIME>', '0000-00-00 00:00:00', (SELECT COUNT(m.id) FROM `<DB_PREFIX>modules` m));
