...
(3, '', 'social_settings', 'view', 'View Social Settings', 'View settings of the social networks'),
(4, '', 'social_settings', 'edit', 'Edit Social Settings', 'Edit settings of the social networks'),
(5, '', 'social_settings', 'delete', 'Delete Social Settings', 'Delete settings of the social networks'),
...
(18, '', 'ban_lists', 'view', 'View Ban Lists', 'View Ban Lists of the site'),
(19, '', 'ban_lists', 'edit', 'Edit Ban Lists', 'Edit Ban Lists of the site'),
(20, '', 'languages', 'view', 'View Languages', 'View languages installed on the site'),
(21, '', 'languages', 'edit', 'Edit Languages', 'Edit languages installed on the site'),
(22, '', 'vocabulary', 'view', 'View Vocabulary', 'View vocabulary of the site'),
(23, '', 'vocabulary', 'edit', 'Edit Vocabulary', 'Edit vocabulary of the site'),
(24, '', 'modules', 'view', 'View Modules', 'View modules settings and management pages'),
(25, '', 'modules', 'edit', 'Edit Modules', 'Edit, manage, install, uninstall and update modules and module pages'),
(26, '', 'modules', 'view_management', 'View Modules Management', 'View modules management page'),
(27, '', 'modules', 'edit_management', 'Edit Modules Management', 'Edit on modules management page');
...
(10, 1, 'locations/', '', '', 1, 1, 5),
(11, 1, 'currencies/', '', '', 1, 1, 6),
(12, 1, 'paymentProviders/', '', '', 1, 1, 7),
(13, 1, 'emailTemplates/', '', '', 1, 1, 8),
(14, 1, 'banLists/', '', '', 1, 1, 9),
(15, 1, 'index/', '', '', 1, 1, 10),
(16, 2, 'roles/', '', '', 1, 1, 2),
(17, 2, 'admins/', '', '', 1, 1, 1),
...
(7, 7, 'en', 'Social Settings'),
(8, 8, 'en', 'Backend Menu'),
(9, 9, 'en', 'Frontend Menu'),
(10, 10, 'en', 'Locations'),
(11, 11, 'en', 'Currencies'),
(12, 12, 'en', 'Payment Providers'),
(13, 13, 'en', 'Email Templates'),
(14, 14, 'en', 'Ban Lists'),
(15, 15, 'en', 'Preview'),
